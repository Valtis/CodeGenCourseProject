        ...
        public void MinimalProgramIsAccepted()
        {
            ...
            ASTMatches(
                new ProgramNode(
                    ...
                    new BlockNode(0, 0, 
                        new VariableAssignmentNode(0, 0, new IdentifierToken("a"), 
            ...
            ASTMatches(
                new ProgramNode(
                    ...
                    new BlockNode(0, 0,
                        new VariableAssignmentNode(0, 0, new IdentifierToken("a"),
                            new IntegerNode(0, 0, 4)),
                        new VariableAssignmentNode(0, 0, new IdentifierToken("b"),
                            new IntegerNode(0, 0, 5)),
                        new VariableAssignmentNode(0, 0, new IdentifierToken("c"),
        ...
        public void ValidExpressionsAreAccepted()
        {
            ...
            ASTMatches(
                new ProgramNode(0, 0, new IdentifierToken("expression_test"),
                    new BlockNode(0, 0,
                        new VariableAssignmentNode(0, 0, new IdentifierToken("assignment"),
                            new IntegerNode(0, 0, 4)
                        ),
                        new VariableAssignmentNode(0, 0, new IdentifierToken("assinment_with_real"),
                            new RealNode(0, 0, 1432.21)
                        ),
                        new VariableAssignmentNode(0, 0, new IdentifierToken("assignment_with_variable"),
                            new IdentifierNode(0, 0, "hello")
                        ),
                        new VariableAssignmentNode(0, 0, new IdentifierToken("assignment_with_negation"),
                            new IntegerNode(0, 0, -233)
                        ),
                        new VariableAssignmentNode(0, 0, new IdentifierToken("assignment_with_real_negation"),
                            new RealNode(0, 0, -235.12)
                        ),
                        new VariableAssignmentNode(0, 0, new IdentifierToken("assignment_with_variable_negation"),
                            new NegateNode(0, 0,
                                new IdentifierNode(0, 0, "hello")
                            )
                        ),
                        new VariableAssignmentNode(0, 0, new IdentifierToken("assignment_with_not_and_identifier"),
                            new NotNode(0, 0,
                                new IdentifierNode(0, 0, "hello")
                            )
                        ),
                        new VariableAssignmentNode(0, 0, new IdentifierToken("assignment_with_not_and_integer"),
                            new NotNode(0, 0,
                                new IntegerNode(0, 0, 346)
                            )
                        ),
                        new VariableAssignmentNode(0, 0, new IdentifierToken("assignment_with_parenthesis"),
                            new IntegerNode(0, 0, 235)
                        ),
                        new VariableAssignmentNode(0, 0, new IdentifierToken("assignment_of_array_value"),
                            new ArrayIndex(0, 0, new IdentifierToken("arr"),
                                new IntegerNode(0, 0, 4)
                            )
                        ),
                        new VariableAssignmentNode(0, 0, new IdentifierToken("assignment_with_array_index_negation"),
                            new ArrayIndex(0, 0, new IdentifierToken("arr"),
                                new IntegerNode(0, 0, -5)
                            )
                        ),
                        new VariableAssignmentNode(0, 0, new IdentifierToken("assignment_of_array_size"),
                            new ArraySizeNode(0, 0, 
                                new IdentifierNode(0, 0, "foo")
                            )
                        ),
                        new VariableAssignmentNode(0, 0, new IdentifierToken("assignment_of_array_size_with_parenthesis"),
                            new ArraySizeNode(0, 0,
                                new IdentifierNode(0, 0, "foo")
                            )
                        ),
                        new VariableAssignmentNode(0, 0, new IdentifierToken("assignment_of_semantically_invalid_size"),
                            new ArraySizeNode(0, 0,
                                new IntegerNode(0, 0, -235)
                            )
                        )
