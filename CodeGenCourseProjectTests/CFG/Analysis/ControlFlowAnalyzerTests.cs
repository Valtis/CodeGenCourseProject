...
namespace CodeGenCourseProject.CFG.Analysis.Tests
{
    ...
    public class ControlFlowAnalyzerTests
    {
        ...
        public void InvalidProcedure1()
        {
            ...
            Assert.AreEqual(2, reporter.Errors.Count);
            var testHelper = new TestHelper(reporter);
            testHelper.AssertErrorMessage(0, Error.SEMANTIC_ERROR, 5, 19, "Usage of uninitialized variable 'a'");
            testHelper.AssertErrorMessage(1, Error.SEMANTIC_ERROR, 10, 21, "Usage of uninitialized variable 'b'");
        }
        ...
        public void InvalidVariableCapture()
        {
            ...
            var testHelper = new TestHelper(reporter);
            testHelper.AssertErrorMessage(0, Error.SEMANTIC_ERROR, 22, 16, "Captured variable 'c' might be uninitialized at this point");
            testHelper.AssertErrorMessage(1, Error.SEMANTIC_ERROR, 24, 21, "Usage of uninitialized variable 'c'");
            testHelper.AssertErrorMessage(2, Error.SEMANTIC_ERROR, 27, 8, "Captured variable 'a' might be uninitialized");
            testHelper.AssertErrorMessage(3, Error.SEMANTIC_ERROR, 27, 8, "Captured variable 'q' might be uninitialized");
            testHelper.AssertErrorMessage(4, Error.SEMANTIC_ERROR, 30, 13, "Usage of uninitialized variable 'a'");
        }
        ...
        public void InvalidWritelnCall()
        {
            ...
            var testHelper = new TestHelper(reporter);
            testHelper.AssertErrorMessage(0, Error.SEMANTIC_ERROR, 7, 16, "Usage of uninitialized variable 'a'");
            testHelper.AssertErrorMessage(1, Error.SEMANTIC_ERROR, 7, 19, "Usage of uninitialized variable 'b'");
            testHelper.AssertErrorMessage(2, Error.SEMANTIC_ERROR, 7, 22, "Usage of uninitialized variable 'c'");
            testHelper.AssertErrorMessage(3, Error.SEMANTIC_ERROR, 7, 25, "Usage of uninitialized variable 'd'");
        }
        ...
        public void InvalidReadCall()
        {
            ...
            Assert.AreEqual(1, reporter.Errors.Count);
            var testHelper = new TestHelper(reporter);
            testHelper.AssertErrorMessage(0, Error.SEMANTIC_ERROR, 6, 13, "Usage of uninitialized variable 'a'");
        }
        ...
        public void InvalidNormalFunctionCalls()
        {
            ...
            var testHelper = new TestHelper(reporter);
            testHelper.AssertErrorMessage(0, Error.SEMANTIC_ERROR, 14, 22, "Usage of uninitialized variable 'c'");
            testHelper.AssertErrorMessage(1, Error.SEMANTIC_ERROR, 22, 27, "Usage of uninitialized variable 'a'");
            testHelper.AssertErrorMessage(2, Error.SEMANTIC_ERROR, 22, 30, "Usage of uninitialized variable 'b'");
            testHelper.AssertErrorMessage(3, Error.SEMANTIC_ERROR, 22, 34, "Usage of uninitialized variable 'b'");
        }
        ...
        public void InvalidArrayIndexes()
        {
            ...
            var testHelper = new TestHelper(reporter);
            testHelper.AssertErrorMessage(0, Error.SEMANTIC_ERROR, 4, 23, "Usage of uninitialized variable 'a'");
            testHelper.AssertErrorMessage(1, Error.SEMANTIC_ERROR, 5, 23, "Usage of uninitialized variable 'a'");
            testHelper.AssertErrorMessage(2, Error.SEMANTIC_ERROR, 9, 10, "Usage of uninitialized variable 'a'");
            testHelper.AssertErrorMessage(3, Error.SEMANTIC_ERROR, 10, 10, "Usage of uninitialized variable 'a'");
            testHelper.AssertErrorMessage(4, Error.SEMANTIC_ERROR, 10, 22, "Usage of uninitialized variable 'a'");
        }
        ...
        public void InvalidReturnStatements()
        {
            ...
            var testHelper = new TestHelper(reporter);
            testHelper.AssertErrorMessage(0, Error.SEMANTIC_ERROR, 6, 23, "Usage of uninitialized variable 'a'");
            testHelper.AssertErrorMessage(1, Error.SEMANTIC_ERROR, 21, 23, "Usage of uninitialized variable 'c'");
            testHelper.AssertErrorMessage(2, Error.SEMANTIC_ERROR, 16, 8, "Captured variable 'b' might be uninitialized at this point");
        ...
        public void InvalidAsserts()
        {
            ...
            var testHelper = new TestHelper(reporter);
            testHelper.AssertErrorMessage(0, Error.SEMANTIC_ERROR, 3, 15, "Usage of uninitialized variable 'a'");
            testHelper.AssertErrorMessage(1, Error.SEMANTIC_ERROR, 11, 8, "Captured variable 'a' might be uninitialized at this point");
